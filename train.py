...
LOAD_ROOT = "./saved_runs/curric1/4hex3_2-0"
MODEL_LOAD_PATH = LOAD_ROOT + "/conv1mlp2-final.zip"
ENV_LOAD_PATH = LOAD_ROOT + "/_final-vecnormenv_state.pkl"
# LOAD_ROOT = None
# MODEL_LOAD_PATH = None
# ENV_LOAD_PATH = None

SAVE_ROOT = "./saved_runs/curric1/5hex2_1-0"
...
def main():
    ...
    lr_scheduler = get_linear_fn(start=5e-4, end=5e-5, end_fraction=0.7)
